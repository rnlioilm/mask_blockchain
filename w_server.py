...
def create_transaction():
    ...
    sender_address = request_json['sender_address']
    recipient_address = request_json['recipient_address']
    sender_public_key = request_json['sender_public_key']
    value = int(request_json['value'])
    my_number = int(request_json['my_number'])
